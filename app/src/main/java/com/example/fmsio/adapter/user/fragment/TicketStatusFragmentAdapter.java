...
public class TicketStatusFragmentAdapter  extends RecyclerView.Adapter<TicketStatusFragmentAdapter.Holder> {
    ...
    @NonNull
    @Override
    public TicketStatusFragmentAdapter.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new TicketStatusFragmentAdapter.Holder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull TicketStatusFragmentAdapter.Holder holder, int position) {
