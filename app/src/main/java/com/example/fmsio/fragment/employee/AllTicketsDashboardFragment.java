...
import com.example.fmsio.adapter.employee.fragment.AllTicketFragmentAdapter;
import com.example.fmsio.adapterCallBack.employee.fragment.AllTicketAdapterCallBack;
import com.example.fmsio.databinding.FragmentEmployeeAllTicketsDashboardBinding;
import com.example.fmsio.firebaseLiveData.QueryCallBack;
import com.example.fmsio.fragment.employee.TicketDetailsFragment;
...
public class AllTicketsDashboardFragment extends Fragment implements QueryCallBack, AllTicketAdapterCallBack {
    private FragmentEmployeeAllTicketsDashboardBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @androidx.annotation.Nullable ViewGroup container, @androidx.annotation.Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(LayoutInflater.from(getActivity()), R.layout.fragment_employee_all_tickets_dashboard, container, false);
